	...
	<div class="contact-manager" style="min-height:60em;">
		...
		<form method="post" enctype="multipart/form-data" action="edpct.php">
			...
			<div class="form-input-block">
				...
				<input type="text" placeholder="Enter MRP" class="form-inputbox" name="mrp" required value="<?php
																											echo $mrp;
																											?>" />
			</div>
			...
			<div class="form-input-block">
				...
				<input type="text" placeholder="Enter Selling Price" class="form-inputbox" name="price" required value="<?php
																														echo $price;
																														?>" />
			</div>
			...
			<div class="form-input-block">
				...
				<input type="text" placeholder="Enter quantity you have" class="form-inputbox" name="qty" required value="<?php
																															echo $qty;
																															?>" />
			</div>
